...
const Administrator = ({ status, adminData }) => {
   ...
   const handleCreateAdmin = async () => {
    ...
    formData.append('profile_photo', profilePhoto, 'profile_photo.jpg');
         ...
         >
            <>
               <div className='flex'>
                  ...
                  <div className='w-full'>
                     ...
                     <LabelInput
                        ...
                        value={lastName}
                        // setState = {e => setLastName(e.target.value)}
               ...
               <LabelInput
                  ...
                  // setState = {e => setGender(e.target.value)}
                  setState={setGender}
                  value={gender}
                  hasValue
               />
               <LabelInput
                  ...
                  // setState = {e => setRoleId(e.target.value)}
                  setState={setRoleId}
                  value={roleId}
               />
               <LabelInput
